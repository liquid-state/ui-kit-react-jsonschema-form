...
class ArrayField extends Component {
  ...
  renderNormalArray() {
    ...
    const Componento = ArrayFieldTemplate || DefaultNormalArrayFieldTemplate;
    return <Componento {...arrayProps} />;
  }
...
if (process.env.NODE_ENV !== 'production') {
  ArrayField.propTypes = {
    ...
    registry: PropTypes.shape({
      widgets:
        PropTypes.objectOf(PropTypes.oneOfType([PropTypes.func, PropTypes.object])).isRequired,
